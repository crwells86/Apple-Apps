...
//
////         🔹 Add fake transcript for testing
////        transcriber.finalizedTranscript = """
////           so if we push the launch back by two weeks, that gives Sarah enough time to finalize the budget numbers. Once that’s done, I’ll send the notes out to the whole team.
////           John, can you start pulling competitor pricing models
////           """
//    }
//
//    var body: some View {
...
//    }
//
//    // MARK: - Live transcript ScrollViewReader (keeps view scrolled to latest)
//    @ViewBuilder
...
//    }
//
//    // MARK: - Playback ScrollViewReader
...
//            if run.text.characters.contains(where: { $0 == Character("\n") }) {
...
//    // MARK: - Controls
//    func handlePlayback() {
//        // Use the permanent file URL for playback
...
//
//        if isPlaying {
//            // Tell your recorder to play the permanent file
...
//                    let destinationURL = documents.appendingPathComponent("\(recording.id).wav") // match temp extension
//
...
//            }
//        } else {
//            hasGeneratedTitle = false // reset
//
//            // Fire a one-shot task in 5 minutes
//            Task {
